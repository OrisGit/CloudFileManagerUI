export class AppConstants {
  ...
  public static GAMES_API = AppConstants.HOST + AppConstants.API_V1 + '/auth';
  ...
  public static PLATFORM_API = AppConstants.HOST + AppConstants.API_V1 + '/platform';
  public static PUBLISHER_API = AppConstants.HOST + AppConstants.API_V1 + '/publisher';
}
